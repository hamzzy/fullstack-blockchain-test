...
export type { VehicleManager } from "./contracts/Car.sol/VehicleManager";
export { VehicleManager__factory } from "./factories/contracts/Car.sol/VehicleManager__factory";
