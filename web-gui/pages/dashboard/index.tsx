...
import {
  GetAllServiceWorkerQuery,
  useGetAllServiceWorkerQuery,
...
export const Index: FunctionComponent<IndexProps> = () => {
  ...
  const [serviceWorkers, addServiceWorker] = useState<any>([]);
  ...
  const onSubmit: SubmitHandler<IFormInputs> = async (data) => {
    try {
      const service_add = await vehicleContract.addServiceWorker(
    ...
    <Dashboard>
      ...
      <Flex>
        <Stack
          ...
          my={10}
        >
          <Heading>List of service worker added</Heading>
          <ServiceWorkerTable />
        </Stack>
      </Flex>
    </Dashboard>
